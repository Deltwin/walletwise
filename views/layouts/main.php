...
<head>
    ...
    <meta name="application-name" content="walletwise">
...
<?php $this->beginBody() ?>
    <div class="wrap">
        <?php
            NavBar::begin([
                'brandLabel' => '<img src="'.Yii::$app->request->baseUrl.'/images/logo-icon.png" style="height:20px;float:left;margin-right: 5px" align="absbottom">  WalletWise',
            ...
            echo Nav::widget([
                ...
                'items' => [
                    ...
                    ['label' => '<span class="glyphicon glyphicon-eur" aria-hidden="true"></span> '.Yii::t('app', 'Entries'), 'url' => ['/cashbook/index'], 'visible' => !Yii::$app->user->isGuest,],
                    ...
                    'items' => 
                        [
                            ['label' => '<span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> '.Yii::t('app', 'Categories'), 'url' => ['/category/index']],
    ...
    <footer class="footer">
        <div class="container" align="center">
	        <?= Html::a('WalletWise', 'https://github.com/Deltwin/walletwise', ['style' => 'color: blue', 'target'=>'_blank']) ?> &copy; <?= date('Y') ?>  
            <?= Html::a('<i class="fa fa-paypal"></i>', 'https://paypal.me/pay2secure', ['target'=>'_blank']) ?>
	        <?= Html::a('<i class="fa fa-github-square fa-lg"></i>', 'https://github.com/Deltwin', ['target'=>'_blank']) ?> 
        </div>
    </footer>
